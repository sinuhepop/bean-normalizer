...
public class NormalizationException extends RuntimeException {
    ...
    private NormalizationException(Class<? extends PropertyNormalizer> normalizer, Object target, String property, Object value,
    ...
    public static NormalizationException build(Class<? extends PropertyNormalizer> normalizer, Object target, String property, Object value,
            Throwable cause) {
